...
ap.add_argument('-c', '--config', 
                help = 'path to yolo config file', default='/home/josva/Music/yolo-face/face-yolov3-tiny.cfg')
ap.add_argument('-w', '--weights', 
                help = 'path to yolo pre-trained weights', default='face-yolov3-tiny_41000.weights')
ap.add_argument('-cl', '--classes', 
                help = 'path to text file containing class names',default='/home/josva/Music/yolo-face/coco.names')
args = ap.parse_args()
...
window_title= "Blue Brain Robotics"   
...
# Define a folder to save cropped images
folder_name = '/home/josva/Music/yolo-face/croped/'
...
for i in indices:
    ...
    cv2.imwrite(os.path.join(folder_name, f"cropped_{i}.jpg"), crop_img)
